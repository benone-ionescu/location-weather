package ch.user.assessment.locationweather.controller;
...
import ch.user.assessment.locationweather.model.submodelV2.GeoPoint2dV2;
import ch.user.assessment.locationweather.repository.LocationRepository;
